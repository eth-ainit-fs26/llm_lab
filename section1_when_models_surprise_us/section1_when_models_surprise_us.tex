...
\vspace{0.1em}
{\scriptsize \papercite{DeepSeek-AI}{2025}{Nature}{DeepSeek-R1 Incentivizes Reasoning via RL}}
...
\begin{columns}[T]
  \begin{column}{0.48\textwidth}
    ...
    \vspace{0.3em}
    {\scriptsize \papercite{Lightman et al.}{2024}{ICLR}{Let's Verify Step by Step}}
  \end{column}
  \begin{column}{0.48\textwidth}
...
\begin{frame}[allowframebreaks]{References}
  ...
  \begin{thebibliography}{99}
    ...
    \newblock Nature, 645:633--638, 2025.
