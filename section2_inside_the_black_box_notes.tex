...
\end{verbatim}
A sufficiently large language model will complete this with ``maison'' ---
not because it has memorized this translation table, but because it has
\emph{inferred the task} (English-to-French translation) from the examples
and \emph{applied} it to the new input.
\end{examplebox}
